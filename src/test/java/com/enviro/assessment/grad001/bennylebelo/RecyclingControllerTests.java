...
class DisposalControllerTest {
    ...
    void getAllCategories() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/disposal-tip"))
                ...
                .andExpect(jsonPath("$[0].description").value("Compost organic food waste to reduce landfill usage."));
    }
    ...
    void getTipById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/disposal-tip/1"))
                ...
                .andExpect(jsonPath("$.description").value("Compost organic food waste to reduce landfill usage."));
    }
